...
public class VideoUpdateRequest {
    ...
    public VideoUpdateRequest(UUID id,String name,String alias,List<String> type,String description,int numberOfSections,byte[] photoBytes,String directorName,List<String> voiceActor,String date,byte[] videoBytes,String animeCompany,String comicBookAuthor){
        this.id = id;
        this.name = name;
        this.alias = alias;
